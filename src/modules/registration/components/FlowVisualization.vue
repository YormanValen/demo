...
const secondStepDuration = computed(() => (props.processingTime || 2000));
...
const startAnimation = () => {
  ...
  // Completar paso 2 y pasar al paso 3
  setTimeout(() => {
    stepCompleted.value[1] = true;
    currentStep.value = 3;
  }, 1000 + firstStepDuration.value);

  // Completar paso 3
  setTimeout(() => {
    stepCompleted.value[2] = true;
  }, 1000 + firstStepDuration.value + secondStepDuration.value);
};
