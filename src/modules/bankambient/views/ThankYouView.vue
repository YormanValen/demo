  ...
  <div class="thank-you">
    <div class="thank-you-content">
      ...
      <div class="thank-you-message">
        <p>
          Agradecemos profundamente la información proporcionada para conectar
          su institución bancaria. Esto nos permite ofrecerle un crédito de la
          forma más eficiente y personalizada posible.
        </p>
      </div>
        ...
        <div class="feature-item">
          <div class="feature-icon">
            <svg width="48" height="48" viewBox="0 0 48 48" fill="none">
              ...
              <path
                d="M24 8L32 16V32C32 36 24 40 24 40S16 36 16 32V16L24 8Z"
                fill="#001340"
                opacity="0.2"
              />
              <path
        ...
        <div class="feature-item">
          <div class="feature-icon">
            <svg width="48" height="48" viewBox="0 0 48 48" fill="none">
              ...
              <path
                d="M12 36C12 30 17.3 26 24 26S36 30 36 36"
                stroke="#001340"
                stroke-width="2"
                stroke-linecap="round"
              />
      ...
      <div class="contact-info">
        <p class="contact-text">
          Nos pondremos en contacto con usted pronto para continuar con el
